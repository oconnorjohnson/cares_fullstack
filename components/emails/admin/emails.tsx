...
export const PickupEventScheduled: React.FC<Readonly<EmailTemplateProps>> = ({
  firstName,
}) => (
  <Html lang="en">
    <Preview>CARES Assets Added!</Preview>
      ...
      <Body className="">
        <Container className="">
          <Section className="bg-zinc-200 rounded-2xl px-12 py-8">
            ...
            <Text className="text-3xl font-bold">Hi {firstName},</Text>
            <Text className="text-lg">
              A new pickup event has been scheduled! Head over to the{" "}
              <Link href="https://yolopublicdefendercares.org/dashboard">
                dashboard
              </Link>{" "}
              to review.
            ...
            <Button
              className="bg-orange-500 p-4 rounded-xl text-white text-xl font-bold"
              href="https://yolopublicdefendercares.org/admin/pick-ups"
            >
              View Pickup Events
            </Button>
          </Section>
