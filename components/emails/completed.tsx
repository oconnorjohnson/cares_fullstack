...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <Html lang="en">
    <Preview>Post-Screen Completed - Request Closed</Preview>
    <Tailwind
      config={{
        theme: {
          extend: {
        ...
        <Container className="">
          <Section className="bg-zinc-200 rounded-2xl px-12 py-8">
            ...
            <Text className="text-lg">
              Your post-screen has been received and your request is now
              completed and closed. If you have any questions, please reach out
              to us at{" "}
