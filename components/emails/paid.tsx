...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <Html lang="en">
    <Preview>Request Paid - Upload Receipts</Preview>
    <Tailwind
      config={{
        theme: {
          extend: {
        ...
        <Container className="">
          <Section className="bg-zinc-200 rounded-2xl px-12 py-8">
            ...
            <Text className="text-lg">
              Your request has been paid! Head to your dashboard to upload
              receipts and complete your post-screen as soon as possible!
              Failure to do so will effect future ability to submit requests. If
