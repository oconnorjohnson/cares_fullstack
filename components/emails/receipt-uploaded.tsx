...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <Html lang="en">
    <Preview>Receipt Uploaded - Complete Post-Screen</Preview>
    <Tailwind
      config={{
        theme: {
          extend: {
        ...
        <Container className="">
          <Section className="bg-zinc-200 rounded-2xl px-12 py-8">
            ...
            <Text className="text-lg">
              Your receipts have been uploaded! Head to your dashboard to
              complete your post screen as soon as possible! Failure to do so
              will effect future ability to submit requests. If you have any
